...
/*****************************************************************************************
*函数名称：uint8_t dataTransfer(uint8_t *Input, uint8_t *Output, uint8_t  targetFormat)
*输入：uint8_t *Input, uint8_t *Output, uint8_t  targetFormat
*				uint8_t *Input, 输入的数据
*				uint8_t *Output, 输出的数据
*				uint8_t  targetFormat, 输出目标数据Output的格式，取值为 ： 
*																		BCD_FORMAT-BCD格式
